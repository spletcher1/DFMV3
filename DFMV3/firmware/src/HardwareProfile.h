...
#define EXTRALED1ON() PORTDSET = 0x0001
#define EXTRALED2ON() PORTDSET = 0x0002
#define EXTRALED3ON() PORTDSET = 0x0004
#define EXTRALED4ON() PORTDSET = 0x0008


#define EXTRALED1OFF() PORTDCLR = 0x0001
#define EXTRALED2OFF() PORTDCLR = 0x0002
#define EXTRALED3OFF() PORTDCLR = 0x0004
#define EXTRALED4OFF() PORTDCLR = 0x0008

#define FLIP_EXTRALED1() PORTDINV = 0x0001
#define FLIP_EXTRALED2() PORTDINV = 0x0002
#define FLIP_EXTRALED3() PORTDINV = 0x0004
#define FLIP_EXTRALED4() PORTDINV = 0x0008
...
#define RX485_ENABLE_DELAY() Delay10us(100)
